...
import { getFirestore, collection, query, where, getDocs, doc, getDoc, setDoc, deleteDoc, serverTimestamp } from "firebase/firestore";
...
export { app, auth, db, analytics, googleProvider, signInWithPopup, signOut, collection, query, where, getDocs, doc, getDoc, setDoc, deleteDoc, serverTimestamp };
